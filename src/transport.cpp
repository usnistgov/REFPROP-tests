...
std::vector<vel> transport_validation_data = {
    ...
    {"ETHANE", "T", 100, "Dmass", 650, "V", 1050.774, 1e-6},
    {"ETHANE", "T", 300, "Dmass", 0, "V", 9.285785, 1e-6},
    {"ETHANE", "T", 300, "Dmass", 1, "V", 9.293015, 1e-6},
    {"ETHANE", "T", 300, "Dmass", 100, "V", 12.55151, 1e-6},
    {"ETHANE", "T", 300, "Dmass", 500, "V", 114.3985, 1e-6},
    {"ETHANE", "T", 305.322, "Dmass", 206.18,"V", 22.63285, 1e-6},
    {"ETHANE", "T", 310, "Dmass", 1, "V", 9.592824, 1e-6},
    {"ETHANE", "T", 310, "Dmass", 100, "V", 12.88843, 1e-6},
    {"ETHANE", "T", 310, "Dmass", 500, "V", 114.8683, 1e-6},
    {"ETHANE", "T", 500, "Dmass", 1, "V", 14.85686, 1e-6},
    {"ETHANE", "T", 500, "Dmass", 100, "V", 18.82032, 1e-6},
    {"ETHANE", "T", 500, "Dmass", 400, "V", 66.15890, 1e-6},
    {"ETHANE", "T", 675, "Dmass", 0, "V", 18.97242, 1e-6},
    {"ETHANE", "T", 675, "Dmass", 1, "V", 18.99427, 1e-6},
    {"ETHANE", "T", 675, "Dmass", 100, "V", 23.37711, 1e-6},
    {"ETHANE", "T", 675, "Dmass", 300, "V", 45.90524, 1e-6},
    ...
    // Huber, NISTIR, 2018
    {"R1243ZF", "T", 339.2, "Dmolar", 0.0, "L", 17.5435e-3, 1e-8},
    {"R1243ZF", "T", 339.2, "Dmolar", 8901, "L", 59.9260e-3, 1e-8},
